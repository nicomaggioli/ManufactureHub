...
const communications = [
  { id: 'c1', projectId: 'p1', manufacturerId: 'm8', manufacturerName: 'Jiangyin Longma Textile Co., Ltd.', subject: 'Organic cotton fabric samples for Spring 2026', messages: [{ id: 'msg1', sender: 'user' as const, content: 'Hi, we are interested in your GOTS-certified organic cotton in pastel colorways for our Spring 2026 collection. Can you send a swatch book?', createdAt: '2026-03-01T10:00:00Z' }, { id: 'msg2', sender: 'manufacturer' as const, content: 'Thank you for your inquiry. We have 32 pastel colorways available in our OC-200 organic cotton (180gsm). Swatch book shipped via DHL today — tracking number shared separately.', createdAt: '2026-03-02T08:30:00Z' }], status: 'reply_received' as const, lastMessageAt: '2026-03-02T08:30:00Z', createdAt: '2026-03-01T10:00:00Z' },
  { id: 'c2', projectId: 'p2', manufacturerId: 'm5', manufacturerName: 'Nisha Texport Pvt. Ltd.', subject: 'Selvedge denim pricing — 14oz raw', messages: [{ id: 'msg3', sender: 'user' as const, content: 'We are sourcing 14oz raw selvedge denim for a capsule line. Can you provide FOB pricing for 5,000 yards? Also interested in your laser finishing capabilities.', createdAt: '2026-03-05T14:00:00Z' }], status: 'awaiting_reply' as const, lastMessageAt: '2026-03-05T14:00:00Z', createdAt: '2026-03-05T14:00:00Z' },
  { id: 'c3', projectId: 'p3', manufacturerId: 'm1', manufacturerName: 'Guangzhou Shang Ding Garment Co., Ltd.', subject: 'Hoodie and jogger MOQ + lead times', messages: [{ id: 'msg4', sender: 'user' as const, content: 'What are your MOQs and lead times for 320gsm French terry hoodies and joggers? Need custom pantone matching.', createdAt: '2026-02-28T09:00:00Z' }, { id: 'msg5', sender: 'manufacturer' as const, content: 'For hoodies: MOQ 100 pcs/color/size, 25-30 day production after sample approval. Joggers same MOQ, 25 days. Pantone matching available — $50 lab dip fee per color.', createdAt: '2026-03-01T11:00:00Z' }, { id: 'msg6', sender: 'user' as const, content: 'Great. Can you send us your tech pack template? We want to submit specs for 3 colorways.', createdAt: '2026-03-03T16:00:00Z' }], status: 'follow_up_due' as const, lastMessageAt: '2026-03-03T16:00:00Z', createdAt: '2026-02-28T09:00:00Z' },
  { id: 'c4', projectId: 'p1', manufacturerId: 'm6', manufacturerName: 'Lanificio Fratelli Cerruti', subject: 'Cashmere blend availability — Spring knits', messages: [{ id: 'msg7', sender: 'user' as const, content: 'Do you have a cashmere-cotton blend suitable for lightweight spring knitwear? Looking for something around 200gsm.', createdAt: '2026-03-08T10:00:00Z' }, { id: 'msg8', sender: 'manufacturer' as const, content: 'We offer our Cerruti 1881 30/70 cashmere-Supima cotton blend at €32/meter, MOQ 150 meters. Available in 18 colors from our spring palette. Can ship sample cuts within 5 business days.', createdAt: '2026-03-09T09:15:00Z' }], status: 'reply_received' as const, lastMessageAt: '2026-03-09T09:15:00Z', createdAt: '2026-03-08T10:00:00Z' },
];

            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Card className="bg-muted/40 border-0 shadow-none">
                <CardContent className="p-3 text-center">
                  <p className="text-xs font-medium text-muted-foreground">BOM Cost</p>
                  <p className="text-lg font-semibold data-value mt-0.5">
              ...
              <Card className="bg-muted/40 border-0 shadow-none">
                <CardContent className="p-3 text-center">
                  <p className="text-xs font-medium text-muted-foreground">Target Cost</p>
                  <p className="text-lg font-semibold data-value mt-0.5">{formatCurrency(pack.targetCost)}</p>
                </CardContent>
              </Card>
              <Card className="bg-muted/40 border-0 shadow-none">
                <CardContent className="p-3 text-center">
                  <p className="text-xs font-medium text-muted-foreground">Margin</p>
                  <p className="text-lg font-semibold data-value mt-0.5 text-accent">
          ...
          <table className="w-full text-sm">
            ...
            <tfoot>
              <tr className="border-t-2">
                <td colSpan={4} className="pt-2.5 text-right pr-4 text-xs font-medium text-muted-foreground">
                  Total Material Cost
                </td>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                ...
                {sizes.map((s) => (
                  <th key={s} className="pb-2.5 px-4 text-center text-xs font-medium text-muted-foreground">
                    {s}
                  </th>
                ))}
              </tr>
          ...
          <dl className="space-y-4">
            {pack.construction.map((detail, i) => (
              <div key={i} className="flex flex-col sm:flex-row sm:gap-4">
                <dt className="text-xs font-medium text-muted-foreground min-w-[180px] pt-0.5">
                  {detail.label}
                </dt>
